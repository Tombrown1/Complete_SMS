    <?php
        if(isset($_POST['submit'])){
            if(!empty($_POST['course'])){
                echo "<h3> You have selected the following Courses </h3>";
                foreach($_POST['course'] as $course){
                    echo $course . "</p>";
                }
            }else{
                echo "<h3> You have selected at least one Course </h3>";
            }
        }
...
<body>
        <script>
            $(document).ready(function(){
                alert("Welcome Multiple Selector");
            })
        </script>
...
<h1>Multiple select Checkbox</h1>
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
        <table>
            <tr>
            <td><input type="checkbox" name="course[]" value="Wedsite Design"> Website Design </td>
            </tr>
            <tr>
            <td><input type="checkbox" name="course[]" value="Graphics Design"> Graphics  Design </td>
            </tr>
            <tr>
            <td><input type="checkbox" name="course[]" value="Wedsite Development"> Website Development </td>
            </tr>
            <tr>
            <td><input type="checkbox" name="course[]" value="Database Design"> Database Design </td>
            </tr>
        </table>
...
<!-- Corrections on insertion of checkbox values in arrays -->
    ...
    if(isset($_POST['submit'])){
        ...
        if(mysqli_num_rows($result)>0){
            while($row_course = mysqli_fetch_assoc($result)){
                ...
                {
                    insert_student_courses($mysqli, $new_stud_id, $course_id);
            ...
            <div class="form-group">
                ...
                <?php                   
                    ...
                    if(mysqli_num_rows($result)>0){
                        ...
                        //    }                           
                ?>
                <input type="checkbox" name='<?php echo "update_course".$course_id;?>[]' value="<?php echo $course_id; ?>" <?php if($checked==true){echo "checked";}?>> &nbsp;&nbsp;&nbsp; <?php echo $course_name; ?><br/>
               <?php
