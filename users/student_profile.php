<?php 
    ...
    //  $user_res= get_users($mysqli);
    //     if(mysqli_num_rows($user_res)>0){
    //         $user_row = mysqli_fetch_assoc($user_res)
    //      //   while($user_row = mysqli_fetch_assoc($user_res)){
    //           //  $std_user_id = $user_row['new_stud_id'];

    //          $result = get_student_by_id($mysqli,// $std_id==$std_user_id);
    //          if(mysqli_num_rows($result)){
    //              while($student_rows = mysqli_fetch_assoc($result)){
    //                  $std_id = $student_rows['std_id'];
    //              }
    //          }
...
<body>
    ...
    ?>      
          <main class="container">
            ...
            <p class="float-left"><a href="index.php" class="btn btn-primary" role="button">Back</a></p>
              <br>      
            </div>             
        </main>   
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="tab-content m1-1" id="myTabcontent">
                                        ...
                                        <div class="form-group">
                                                <a class="btn btn-primary btn-lg" href="edit_stud_profile.php?update=1&std_id=<?php echo $student_rows['std_id']; ?>"  role="button" aria-controls="edit" aria-selected="false">Edit</a>                                               
                                        </div>
                                    </div>
                                </div>
                            </div>
