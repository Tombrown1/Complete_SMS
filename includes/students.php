<?php
    ...
    function update_student_by_id($mysqli, $std_id, $std_name, $std_email, $std_phone, $gender_id, $sponsor_id, $duration_id, $payment_id, $pay_type_id, $fileNewname){
       // global $mysqli;
        $query = "UPDATE student SET std_name ='".$std_name."', std_email ='".$std_email."', std_phone ='". $std_phone."', gender_id ='".$gender_id."', sponsor_id ='". $sponsor_id."', duration_id ='".$duration_id."', payment_id ='".$payment_id."', pay_type_id ='".$pay_type_id."', image='".$fileNewname."' WHERE std_id=".$std_id;
        $result = mysqli_query($mysqli, $query) or die(mysqli_error($mysqli));
        $insert_id = mysqli_insert_id($mysqli);
        return $result;
